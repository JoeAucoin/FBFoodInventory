...
<asp:Button ID="btnProductCategories" runat="server" Text="ProductCategories" resourcekey="btnProductCategories" CssClass="btn btn-lg btn-primary" onclick="btnProductCategories_Click" />
...
<asp:Button ID="btnSuppliers" resourcekey="btnSuppliers" runat="server" CssClass="btn btn-sm btn-default" Text="Suppliers" onclick="btnSuppliers_Click" />
     &nbsp;  &nbsp;
<asp:Button ID="btnInvoices" runat="server" CssClass="btn btn-sm btn-default" resourcekey="btnInvoices" Text="Invoices" onclick="btnInvoices_Click" />
     &nbsp; &nbsp;
